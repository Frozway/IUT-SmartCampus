...
class TechControllerTest extends WebTestCase
{
    ...
    public function testAcquisitionSystemListForTech(): void
    {
        ...
        //Seule la liste des AS du technicien à le titre de "Systèmes d'aquisition installés"
        $this->assertSelectorTextContains('div.fs-5', "Systèmes d'aquisition installés");
    }
    ...
    public function testGlobalTechDashboard(): void
    {
        ...
        // Vérifier que le technicien à bien accès à ses 3 colonnes de gestion
        // (Systèmes d'aquisition installés, Opérations à effectuer, Notifications)
